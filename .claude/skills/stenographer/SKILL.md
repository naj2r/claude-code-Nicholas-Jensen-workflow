...
The stenographer produces the raw material. The orchestrator decides what's analytically significant enough for the session log narrative.
...
Users can also run `/stenographer` manually to force a log entry at any point.
