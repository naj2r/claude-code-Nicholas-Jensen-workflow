...
1. **Read the current draft** (the latest version provided, or the most recent draft file in the working directory)
...
- Never treat writing as the user's voice if it appears to have a non-co-author author. Flag it and skip.
