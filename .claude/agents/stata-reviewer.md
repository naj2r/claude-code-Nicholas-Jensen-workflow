...
- Cluster specification present (`vce(cluster [unit])`)
- `eststo` used to store estimates before `esttab`
- `esttab` output goes to the project's designated table output directory
...
- Output filename follows project naming convention
