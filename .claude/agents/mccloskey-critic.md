...
[1] CARDINAL — Rule 25: Use Active Verbs (−5)
    Line ~42: "It was **found** that electoral pressure **is associated** with increased activity."
...
[2] CARDINAL — Rule 12: Avoid Boilerplate (−5)
    Lines ~1-3: "**This paper examines** the relationship between X and Y. **The remainder of this paper is organized as follows.**"
...
[3] CARDINAL — Rule 27: Be Concrete (−5)
    Line ~15: "**The literature has extensively documented** the **significant impact** of [variable]."
...
[4] MAJOR — Rule 26: Avoid Bad Words (−3)
    Line ~28: "This has **significant implications** for the **conceptualization** of [concept]."
...
[5] MAJOR — Rule 30: Bare Demonstratives (−3)
    Line ~35: "**This** suggests that [X] matters."
